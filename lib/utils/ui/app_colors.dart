...
class AppColors {
  static const Color principal = Color(0xFF7B046F); // Rosa oscuro
  static const Color secondary = Color(0xFFFFA0D8); // Rosa claro
  static const Color tertiary = Color(0xFFFF008E); // Rosa medio
  static const Color disabled = Color(0xFFBDBDBD); // Gris claro
  static const Color appBackground = Color(0xFFFFFFFF); // Blanco
  static const Color textPrimary = Color(0xFF212121); // Negro oscuro
